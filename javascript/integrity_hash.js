...
function clearIntegrityTextboxes() {
  document.getElementById("integrityMessage").value = '';
  document.getElementById("integritySecret").value = '';
  document.getElementById("integrityMessageHash").value = '';
  document.getElementById("integrityConcatenatedHash").value = '';
}

window.addEventListener('load', clearIntegrityTextboxes);
